...
function SplashCursor({
    ...
    `;
      ...
      `
        ...
        // Custom color generator for purple/cyan theme
        function generateColor() {
            // Generate colors in the purple-cyan spectrum (hues 180-300)
            const hueRange = Math.random();
            let h: number;

            if (hueRange < 0.5) {
                // Purple range (270-300)
                h = 0.75 + Math.random() * 0.083;
            } else {
                // Cyan range (180-210)
                h = 0.5 + Math.random() * 0.083;
            }
